...
class BasicMolecularMetrics(object):
    def __init__(self, dataset_info, dataset_smiles_list=None, cv_value=None):
    ...
    def compute_validity(self, generated):
        ...
        with open(f'valid_molecules_gap_test.txt', 'w') as file:
    ...
    def compute_uniqueness(self, valid):
        ...
        with open(f'unique_molecules_gap_test.txt', 'w') as file:
    ...
    def compute_novelty(self, unique):
        ...
        with open(f'novel_molecules_gap_test.txt', 'w') as file:
            for molecule in novel:
                file.write(molecule + '\n')
