...
class EGNN_dynamics_QM9(nn.Module):
    def __init__(self, in_node_nf, context_node_nf,
        ...
        print(in_node_nf, context_node_nf,n_dims, device, hidden_nf,act_fn, n_layers,attention, tanh, mode, norm_constant,inv_sublayers, sin_embedding,normalization_factor, aggregation_method)
